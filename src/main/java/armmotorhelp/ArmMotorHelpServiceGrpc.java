...
public final class ArmMotorHelpServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<armmotorhelp.Proto2.ArmState,
      armmotorhelp.Proto2.ArmSessionSummary> getStreamArmStateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamArmState",
      requestType = armmotorhelp.Proto2.ArmState.class,
      responseType = armmotorhelp.Proto2.ArmSessionSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<armmotorhelp.Proto2.ArmState,
      armmotorhelp.Proto2.ArmSessionSummary> getStreamArmStateMethod() {
    io.grpc.MethodDescriptor<armmotorhelp.Proto2.ArmState, armmotorhelp.Proto2.ArmSessionSummary> getStreamArmStateMethod;
      ...
      synchronized (ArmMotorHelpServiceGrpc.class) {
        if ((getStreamArmStateMethod = ArmMotorHelpServiceGrpc.getStreamArmStateMethod) == null) {
          ArmMotorHelpServiceGrpc.getStreamArmStateMethod = getStreamArmStateMethod = 
              io.grpc.MethodDescriptor.<armmotorhelp.Proto2.ArmState, armmotorhelp.Proto2.ArmSessionSummary>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "armmotorhelp.ArmMotorHelpService", "StreamArmState"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  armmotorhelp.Proto2.ArmState.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  armmotorhelp.Proto2.ArmSessionSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<armmotorhelp.Proto2.EmergencyStopRequest,
      armmotorhelp.Proto2.EmergencyStopAck> getEmergencyStopMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EmergencyStop",
      requestType = armmotorhelp.Proto2.EmergencyStopRequest.class,
      responseType = armmotorhelp.Proto2.EmergencyStopAck.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<armmotorhelp.Proto2.EmergencyStopRequest,
      armmotorhelp.Proto2.EmergencyStopAck> getEmergencyStopMethod() {
    io.grpc.MethodDescriptor<armmotorhelp.Proto2.EmergencyStopRequest, armmotorhelp.Proto2.EmergencyStopAck> getEmergencyStopMethod;
      ...
      synchronized (ArmMotorHelpServiceGrpc.class) {
        if ((getEmergencyStopMethod = ArmMotorHelpServiceGrpc.getEmergencyStopMethod) == null) {
          ArmMotorHelpServiceGrpc.getEmergencyStopMethod = getEmergencyStopMethod = 
              io.grpc.MethodDescriptor.<armmotorhelp.Proto2.EmergencyStopRequest, armmotorhelp.Proto2.EmergencyStopAck>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "armmotorhelp.ArmMotorHelpService", "EmergencyStop"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  armmotorhelp.Proto2.EmergencyStopRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  armmotorhelp.Proto2.EmergencyStopAck.getDefaultInstance()))
  ...
  public static abstract class ArmMotorHelpServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<armmotorhelp.Proto2.ArmState> streamArmState(
        io.grpc.stub.StreamObserver<armmotorhelp.Proto2.ArmSessionSummary> responseObserver) {
      return asyncUnimplementedStreamingCall(getStreamArmStateMethod(), responseObserver);
    }

    /**
     */
    public void emergencyStop(armmotorhelp.Proto2.EmergencyStopRequest request,
        io.grpc.stub.StreamObserver<armmotorhelp.Proto2.EmergencyStopAck> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                armmotorhelp.Proto2.ArmState,
                armmotorhelp.Proto2.ArmSessionSummary>(
                  this, METHODID_STREAM_ARM_STATE)))
          .addMethod(
            getEmergencyStopMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                armmotorhelp.Proto2.EmergencyStopRequest,
                armmotorhelp.Proto2.EmergencyStopAck>(
  ...
  public static final class ArmMotorHelpServiceBlockingStub extends io.grpc.stub.AbstractStub<ArmMotorHelpServiceBlockingStub> {
    ...
    /**
     */
    public armmotorhelp.Proto2.EmergencyStopAck emergencyStop(armmotorhelp.Proto2.EmergencyStopRequest request) {
  ...
  public static final class ArmMotorHelpServiceFutureStub extends io.grpc.stub.AbstractStub<ArmMotorHelpServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<armmotorhelp.Proto2.EmergencyStopAck> emergencyStop(
        armmotorhelp.Proto2.EmergencyStopRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EMERGENCY_STOP:
          serviceImpl.emergencyStop((armmotorhelp.Proto2.EmergencyStopRequest) request,
              (io.grpc.stub.StreamObserver<armmotorhelp.Proto2.EmergencyStopAck>) responseObserver);
          break;
        default:
  ...
  private static abstract class ArmMotorHelpServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return armmotorhelp.Proto2.getDescriptor();
    }
